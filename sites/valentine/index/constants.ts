...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    emoji: "📸",
    content: "Company trip, bức ảnh chung đầu tiên 📷",
  ...
  },
  {
    ...
    emoji: "🎵",
    content: "Em nói mình chỉ là 'đồng nghiệp cũ'... anh cười mà đau trong tim 😅",
  ...
  },
  {
    ...
    emoji: "🌅",
    content: "Cờ vây thì là khởi đầu... và sau đó là những chia sẻ sâu sắc, và là cái nắm tay ngọt ngào đầu tiên <3",
  ...
  },
  {
    ...
    emoji: "💋",
    content: "Em bắt anh phải đuổi theo em hoài à, nhưng mà, anh vẫn sẽ luôn đuổi theo em hehe",
